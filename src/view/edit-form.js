  ...
  <section class="event__details">
    <section class="event__section  event__section--offers">
      ...
      `<div class="event__offer-selector">
        <input class="event__offer-checkbox  visually-hidden" id="event-offer-${formatOfferstitle(offer.title)}-1" 
        type="checkbox" name="event-offer-${formatOfferstitle(offer.title)}" ${point.offers.includes(offer.id) ? 'checked' : ''}>
        <label class="event__offer-label" for="event-offer-${formatOfferstitle(offer.title)}-1">
